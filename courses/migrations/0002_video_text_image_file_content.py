    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to={'model_in': ('text', 'video', 'file', 'image')}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
