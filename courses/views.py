...
#integrating formset to course module
...
#adding course content to modules
...
class ContentCreateUpdateView(TemplateResponseMixin, View):
    ...
    def post(self, request, module_id, model_name, id = None):
        ...
        if form.is_valid():
            ...
            if not id:
                #create a new content if does not exist
...
#reordering modules using django-braces 
#the moduleorderview allows updating of the order of couse modules
...
'''displaying courses:
    create a function that lists all courses
    and display a single course view after filtering
    '''
...
'''view function that diaplsys details of a course '''
